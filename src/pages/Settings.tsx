...
const Settings: React.FC = () => {
  ...
  // Estados para Clonado de Propiedad en Configuración
  ...
  // Cargar inventario cuando la pestaña Clonar esté activa
  useEffect(() => {
    if (activeTab === 'clone_property') {
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden min-h-[400px]">
          ...
          {/* VISTA: CLONAR PROPIEDAD */}
          {activeTab === 'clone_property' && (
            <div className="p-6 space-y-6 animate-in fade-in duration-300">
